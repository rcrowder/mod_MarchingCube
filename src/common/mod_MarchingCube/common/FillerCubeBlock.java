...
public class FillerCubeBlock extends Block
{
    ...
    public void onBlockAdded(World par1World, int par2, int par3, int par4)
	{
        ...
        {
            cornerBlockIds[var5] = par1World.getBlockId(
        										par2 + cornerBlockOffsets[var5].posX, 
        										par3 + cornerBlockOffsets[var5].posY,
        										par4 + cornerBlockOffsets[var5].posZ);
            
        	cornerBlockMaterials[var5] = 
        			(cornerBlockIds[var5] == 0 ? Material.air : Block.blocksList[cornerBlockIds[var5]].blockMaterial);
